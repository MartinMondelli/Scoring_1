...
stargazer(Altman_Rijken_model_real_mean, type = "latex", title = "Altman & Rijken 2004 Model")
...
stargazer(altman_model_winsorized_real_mean, type = "latex", title = "Result Baseline model winsorized (wide)")
...
stargazer(altman_rijken_model_winsorized_real_mean, type = "latex", title = "Result Altman & Rijken 2004 model winsorized (wide)")
...
stargazer(altman_rijken_model_DtD_winsorized_real_mean, type = "latex", title = "Result Altman & Rijken 2004 model with DtD winsorized (wide)")
...
filtered_wrds_exterior_dtd <- left_join(df_A_clean, compustat_dtd_2, by=c("gvkey","permno"))
...
#Exploration not included in the report
