...
stargazer(baseline_model, type = "latex", title = "Result Baseline model (long)")
...
stargazer(baseline_model_real, type = "latex", title = "Result Baseline model X1-X5 (long)")
...
stargazer(Altman_Rijken_model_real, type = "latex", title = "Result Altman & Rijken (long)")
...
stargazer(baseline_model_real_w, type = "latex", title = "Result Altman winsorized with DtD (long)")
...
stargazer(Altman_Rijken_model_real_w, type = "latex", title = "Result Altman & Rijken with DtD winsorized (long)")
...
stargazer(model_DtD, type = "latex", title = "Result DtD alone (long)")
...
stargazer(baseline_model_real_w_DtD, type = "latex", title = "Result Baseline model + DtD (long)")
...
compustat_dtd <- compustat_dtd %>%
  ...
  select(-date)
filtered_wrds_long_DtD <- left_join(filtered_wrds_long_w_final_DtD, compustat_dtd) #Why so big?
...
stargazer(baseline_model_real_DtD, type = "latex", title = "Result Altman with real DtD winsorized (long)")
...
stargazer(Altman_Rijken_model_real_DtD, type = "latex", title = "Result Altman & Rijken 2004 model with real DtD winsorized (long)")
...
stargazer(baseline_model_real_w_DtD_gdp_vol, type = "latex", title = "Result Altman model with naive DtD winsorized (long)")
